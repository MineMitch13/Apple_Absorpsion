...
execute as @a[scores={deathreset=1}] run scoreboard players set @a[scores={ga_eaten=1..}] ga_eaten 0
execute as @a[scores={deathreset=1}] run scoreboard players set @a[scores={deathreset=1}] deathreset 0